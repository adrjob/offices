<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    ...
    function delete_row(id) {
            ...
            if(confirm("Are you sure you want to delete this Record?")){
                $.ajax({
                    url: '/api/receivables/istanbul/' + id,
                    type: 'DELETE',
                })
                .done(function() {
                    console.log("success");
                    table.ajax.url('/api/receivables/istanbul/').load();                
                })
                .fail(function() {
                    console.log("error");
                })
        ...
        $('#search-month').on('change', function () {
            table.ajax.url('/api/receivables/istanbul/' + this.value).load();
        });        
    </script>
    @endpush
</x-page-template>
