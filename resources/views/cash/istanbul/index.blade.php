<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    <x-auth.navbars.sidebar activePage="cash_istanbul" activeItem="cash_istanbul" activeSubitem="">
    </x-auth.navbars.sidebar>    
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-auth.navbars.navs.auth pageTitle="Cash Istanbul"></x-auth.navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="row mt-4">
                ...
                <div class="col-12">
                    ...
                    <div class="card-header">
                            <h5 class="mb-0">Cash Istanbul</h5>     
                            <div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="card-body">
                                    <form role="form text-left" autocomplete="off"  method="POST" action="{{ route('cash.istanbul.store') }}" enctype="multipart/form-data">
                                    @csrf    
    ...
    function delete_row(id) {
            ...
            if(confirm("Are you sure you want to delete this Record?")){
                $.ajax({
                    url: '/api/cash/istanbul/' + id,
                    type: 'DELETE',
                })
                .done(function() {
                    console.log("success");
                    table.ajax.url('/api/cash/istanbul/').load();                
                })
                .fail(function() {
                    console.log("error");
                })
        ...
        var table = $('#example').DataTable({
            ...
            columnDefs: [                                       
                ...
                },               
                {
                    ...
                    var editar = '<a href="/edit-cash/'+row.id+'/istanbul" rel="tooltip" class="btn bg-gradient-success btn-sm myCustomButton"><i class="material-icons">edit</i><div class="ripple-container"></div></a>';                    
        ...
        $('#search-month').on('change', function () {
            table.ajax.url('/api/cash/istanbul/' + this.value).load();
        });        
    </script>
    @endpush
</x-page-template>
