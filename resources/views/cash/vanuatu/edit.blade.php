            ...
            <div class="row mt-4">
                <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card-body">
                            <form role="form text-left" autocomplete="off"  method="POST" action="{{ route('edit.cash.update', 'vanuatu') }}" enctype="multipart/form-data">
                                @csrf
                            ...
                            <input type="hidden" name="country" value="vanuatu">
